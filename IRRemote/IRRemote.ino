...
void loop() {
  {
    Serial.println("sending activate signals");
    irsend.sendNEC(0x6B900FF, 32);
    Serial.println("Sending NEC finished");
    delay(1000);
    irsend.sendSAMSUNG(0xE0E040BF, 32);
    Serial.println("Sending SAMSUNG finished");
    delay(2000);
  }
  if (irrecv.decode(&results)) {
    ...
    Serial.println("Source code end");
